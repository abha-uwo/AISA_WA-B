...
from .views import RegisterView, LoginView, ClientViewSet, AutomationViewSet, WorkflowViewSet, AdminStatsView, AdminAutomationsView, AdminMessagesView, WhatsAppWebhookView, AdminUsersView, ProfileView, ClientMessagesView
...
urlpatterns = [
    ...
    path('admin/users/<int:pk>', AdminUsersView.as_view(), name='admin-user-detail'),
